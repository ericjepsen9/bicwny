...
- 任何业务规则的回答都要引用具体的 D 编号或能力编号
- 写新的业务能力前,先打开 06-business-capabilities-WIP.md 看现有能力
- 如果你的"印象"和文档不一致,**永远以文档为准**,不要凭印象
- 如果文档没说,先停下来问用户,不要自己决定

## 业务讨论的核对风格

用户的工作方式:
- 用户是产品负责人,不写代码,只用业务语言交流
- 用户喜欢"每条决策与我核对"的节奏
- 写完一条业务能力后,先贴给用户看,不要直接写入文件
- 用户认可后,你才追加到文档,然后等用户说"下一条"
- 用户回答可能很短(如"通过"、"按建议"、"a"),你要根据上下文正确理解
- 如果用户说某条决策错了,立即停下来调整,不要继续推进
- 任何"顺便优化"都是越权,需要先问用户
