...
export const DAYS: DaySpec[] = [
  ...
  // ── 2026 年 10 月 · 善缘 · 具贤月(10/1) / 天降月(10/11+) ─────────────────
  {
    date: '2026-10-01',
    lunar: '八月廿一', tibetan: '八月二十', tibetanMonth: '具贤月',
    publicHoliday: '国庆节',
  },
  {
    date: '2026-10-02',
    lunar: '八月廿二', tibetan: '八月廿一', tibetanMonth: '具贤月',
    auspicious: true,
    events: ['地藏菩萨加持日,作何善恶成亿倍', '燃灯古佛圣诞日(汉)'],
  },
  {
    date: '2026-10-03',
    lunar: '八月廿三', tibetan: '八月廿二', tibetanMonth: '具贤月',
    tags: ['十斋日'],
  },
  {
    date: '2026-10-04',
    lunar: '八月廿四', tibetan: '八月廿三', tibetanMonth: '具贤月',
    tags: ['十斋日'],
    events: ['理发吉日：增上财富'],
  },
  {
    date: '2026-10-05',
    lunar: '八月廿五', tibetan: '八月廿五', tibetanMonth: '具贤月',
    auspicious: true,
    events: ['空行母荟供日,作何善恶成十万倍'],
  },
  {
    date: '2026-10-06',
    lunar: '八月廿六', tibetan: '八月廿六', tibetanMonth: '具贤月',
    events: ['理发吉日：增上安乐'],
  },
  {
    date: '2026-10-07',
    lunar: '八月廿七', tibetan: '八月廿七', tibetanMonth: '具贤月',
    tags: ['九凶同聚'],
    events: ['理发吉日：诸事吉祥'],
  },
  {
    date: '2026-10-08',
    lunar: '八月廿八', tibetan: '八月廿八', tibetanMonth: '具贤月',
    tags: ['八吉同聚', '十斋日'],
    publicHoliday: '寒露',
  },
  {
    date: '2026-10-09',
    lunar: '八月廿九', tibetan: '八月廿九', tibetanMonth: '具贤月',
    tags: ['十斋日'],
  },
  {
    date: '2026-10-10',
    lunar: '九月初一', tibetan: '八月三十', tibetanMonth: '具贤月',
    tags: ['十斋日'], auspicious: true,
    events: ['释迦牟尼佛加持日,作何善恶成九亿倍'],
  },
  {
    date: '2026-10-11',
    lunar: '九月初二', tibetan: '九月初一', tibetanMonth: '天降月',
    auspicious: true,
    events: ['禅定胜王佛加持日,作何善恶成百倍'],
  },
  {
    date: '2026-10-12',
    lunar: '九月初三', tibetan: '九月初二', tibetanMonth: '天降月',
  },
  {
    date: '2026-10-13',
    lunar: '九月初四', tibetan: '九月初三', tibetanMonth: '天降月',
    events: ['理发吉日：家族增长财富'],
  },
  {
    date: '2026-10-14',
    lunar: '九月初五', tibetan: '九月初四', tibetanMonth: '天降月',
    events: ['理发吉日：怀业增上，容光焕发'],
  },
  {
    date: '2026-10-15',
    lunar: '九月初六', tibetan: '九月初五', tibetanMonth: '天降月',
    events: ['理发吉日：聚集广大财富'],
  },
  {
    date: '2026-10-16',
    lunar: '九月初七', tibetan: '九月初六', tibetanMonth: '天降月',
  },
  {
    date: '2026-10-17',
    lunar: '九月初八', tibetan: '九月初七', tibetanMonth: '天降月',
    tags: ['十斋日'],
  },
  {
    date: '2026-10-18',
    lunar: '九月初九', tibetan: '九月初八', tibetanMonth: '天降月',
    auspicious: true,
    events: ['药师佛加持日,作何善恶成千倍', '摩利支天菩萨圣诞(汉)', '理发吉日：长寿'],
    publicHoliday: '重阳节',
  },
  {
    date: '2026-10-19',
    lunar: '九月初十', tibetan: '九月初九', tibetanMonth: '天降月',
    events: ['理发吉日：易遇佳人'],
  },
  {
    date: '2026-10-20',
    lunar: '九月十一', tibetan: '九月闰初九', tibetanMonth: '天降月',
    isIntercalary: true,
  },
  {
    date: '2026-10-21',
    lunar: '九月十二', tibetan: '九月初十', tibetanMonth: '天降月',
    tags: ['飞幡日'], auspicious: true,
    events: ['莲师荟供日,作何善恶成十万倍', '理发吉日：增上欢喜'],
  },
  {
    date: '2026-10-22',
    lunar: '九月十三', tibetan: '九月十一', tibetanMonth: '天降月',
    tags: ['八吉同聚'],
    events: ['理发吉日：增上智慧和世聪'],
  },
  {
    date: '2026-10-23',
    lunar: '九月十四', tibetan: '九月十二', tibetanMonth: '天降月',
    publicHoliday: '霜降',
  },
  {
    date: '2026-10-24',
    lunar: '九月十五', tibetan: '九月十三', tibetanMonth: '天降月',
    tags: ['十斋日'],
    events: ['理发吉日：精进于佛法修持，最上'],
  },
  {
    date: '2026-10-25',
    lunar: '九月十六', tibetan: '九月十四', tibetanMonth: '天降月',
    tags: ['十斋日'],
    events: ['理发吉日：财物增多'],
  },
  {
    date: '2026-10-26',
    lunar: '九月十七', tibetan: '九月十五', tibetanMonth: '天降月',
    auspicious: true,
    events: ['阿弥陀佛加持日,作何善恶成百万倍', '理发吉日：福报增上'],
  },
  {
    date: '2026-10-27',
    lunar: '九月十八', tibetan: '九月十六', tibetanMonth: '天降月',
    tags: ['十斋日'],
  },
  {
    date: '2026-10-28',
    lunar: '九月十九', tibetan: '九月十八', tibetanMonth: '天降月',
    auspicious: true,
    events: ['极乐法会开始', '观世音菩萨加持日,作何善恶成千万倍', '观世音菩萨出家日(汉)'],
  },
  {
    date: '2026-10-29',
    lunar: '九月二十', tibetan: '九月十九', tibetanMonth: '天降月',
    events: ['极乐法会', '理发吉日：增胜善法'],
  },
  {
    date: '2026-10-30',
    lunar: '九月廿一', tibetan: '九月二十', tibetanMonth: '天降月',
    events: ['极乐法会'],
  },
  {
    date: '2026-10-31',
    lunar: '九月廿二', tibetan: '九月廿一', tibetanMonth: '天降月',
    auspicious: true,
    events: ['极乐法会', '地藏菩萨加持日,作何善恶成亿倍'],
  },

  // ── 2026 年 11 月 · 慈悲喜舍 · 天降月(11/1-9) / 持众月(11/10+) ──────────
  {
    date: '2026-11-01',
    lunar: '九月廿三', tibetan: '九月廿二', tibetanMonth: '天降月',
    tags: ['十斋日', '飞幡日'], auspicious: true,
    events: ['极乐法会', '释迦牟尼佛天降日'],
  },
  {
    date: '2026-11-02',
    lunar: '九月廿四', tibetan: '九月廿三', tibetanMonth: '天降月',
    tags: ['八吉同聚', '十斋日'],
    events: ['极乐法会', '理发吉日：增上财富'],
  },
  {
    date: '2026-11-03',
    lunar: '九月廿五', tibetan: '九月廿四', tibetanMonth: '天降月',
    events: ['极乐法会'],
  },
  {
    date: '2026-11-04',
    lunar: '九月廿六', tibetan: '九月廿五', tibetanMonth: '天降月',
    tags: ['九凶同聚'], auspicious: true,
    events: ['极乐法会结束', '空行母荟供日,作何善恶成十万倍'],
  },
  {
    date: '2026-11-05',
    lunar: '九月廿七', tibetan: '九月廿六', tibetanMonth: '天降月',
    events: ['理发吉日：增上安乐'],
  },
  {
    date: '2026-11-06',
    lunar: '九月廿八', tibetan: '九月廿七', tibetanMonth: '天降月',
    tags: ['十斋日'],
    events: ['理发吉日：诸事吉祥'],
  },
  {
    date: '2026-11-07',
    lunar: '九月廿九', tibetan: '九月廿八', tibetanMonth: '天降月',
    tags: ['十斋日'],
    publicHoliday: '立冬',
  },
  {
    date: '2026-11-08',
    lunar: '九月三十', tibetan: '九月廿九', tibetanMonth: '天降月',
    tags: ['十斋日'], auspicious: true,
    events: ['药师佛圣诞日(汉)'],
  },
  {
    date: '2026-11-09',
    lunar: '十月初一', tibetan: '九月三十', tibetanMonth: '天降月',
    tags: ['十斋日'], auspicious: true,
    events: ['释迦牟尼佛加持日,作何善恶成九亿倍'],
  },
  {
    date: '2026-11-10',
    lunar: '十月初二', tibetan: '十月初一', tibetanMonth: '持众月',
    auspicious: true,
    events: ['禅定胜王佛加持日,作何善恶成百倍'],
  },
  {
    date: '2026-11-11',
    lunar: '十月初三', tibetan: '十月初二', tibetanMonth: '持众月',
  },
  {
    date: '2026-11-12',
    lunar: '十月初四', tibetan: '十月初三', tibetanMonth: '持众月',
    events: ['理发吉日：家族增长财富'],
  },
  {
    date: '2026-11-13',
    lunar: '十月初五', tibetan: '十月初四', tibetanMonth: '持众月',
    auspicious: true,
    events: ['达摩祖师诞辰日(汉)', '理发吉日：怀业增上，容光焕发'],
  },
  {
    date: '2026-11-14',
    lunar: '十月初六', tibetan: '十月初五', tibetanMonth: '持众月',
    events: ['理发吉日：聚集广大财富'],
  },
  {
    date: '2026-11-15',
    lunar: '十月初七', tibetan: '十月初六', tibetanMonth: '持众月',
    tags: ['八吉同聚'],
  },
  {
    date: '2026-11-16',
    lunar: '十月初八', tibetan: '十月初七', tibetanMonth: '持众月',
    tags: ['十斋日', '飞幡日'],
  },
  {
    date: '2026-11-17',
    lunar: '十月初九', tibetan: '十月初八', tibetanMonth: '持众月',
    auspicious: true,
    events: ['药师佛加持日,作何善恶成千倍', '理发吉日：长寿'],
  },
  {
    date: '2026-11-18',
    lunar: '十月初十', tibetan: '十月初九', tibetanMonth: '持众月',
    events: ['理发吉日：易遇佳人'],
  },
  {
    date: '2026-11-19',
    lunar: '十月十一', tibetan: '十月初十', tibetanMonth: '持众月',
    auspicious: true,
    events: ['莲师荟供日,作何善恶成十万倍', '理发吉日：增上欢喜'],
  },
  {
    date: '2026-11-20',
    lunar: '十月十二', tibetan: '十月十一', tibetanMonth: '持众月',
    events: ['理发吉日：增上智慧和世聪'],
  },
  {
    date: '2026-11-21',
    lunar: '十月十三', tibetan: '十月十二', tibetanMonth: '持众月',
  },
  {
    date: '2026-11-22',
    lunar: '十月十四', tibetan: '十月十三', tibetanMonth: '持众月',
    tags: ['十斋日'],
    events: ['理发吉日：精进于佛法修持，最上'],
    publicHoliday: '小雪',
  },
  {
    date: '2026-11-23',
    lunar: '十月十五', tibetan: '十月十四', tibetanMonth: '持众月',
    tags: ['十斋日'],
    events: ['理发吉日：财物增多'],
  },
  {
    date: '2026-11-24',
    lunar: '十月十六', tibetan: '十月十五', tibetanMonth: '持众月',
    auspicious: true,
    events: ['阿弥陀佛加持日,作何善恶成百万倍', '理发吉日：福报增上'],
  },
  {
    date: '2026-11-25',
    lunar: '十月十七', tibetan: '十月十六', tibetanMonth: '持众月',
  },
  {
    date: '2026-11-26',
    lunar: '十月十八', tibetan: '十月十七', tibetanMonth: '持众月',
    tags: ['十斋日'],
    publicHoliday: '感恩节',
  },
  {
    date: '2026-11-27',
    lunar: '十月十九', tibetan: '十月十八', tibetanMonth: '持众月',
    tags: ['八吉同聚'], auspicious: true,
    events: ['观世音菩萨加持日,作何善恶成千万倍'],
  },
  {
    date: '2026-11-28',
    lunar: '十月二十', tibetan: '十月十九', tibetanMonth: '持众月',
    tags: ['飞幡日'], auspicious: true,
    events: ['文殊菩萨出家日(汉)', '理发吉日：增胜善法'],
  },
  {
    date: '2026-11-29',
    lunar: '十月廿一', tibetan: '十月二十', tibetanMonth: '持众月',
    auspicious: true,
    events: ['地藏菩萨加持日,作何善恶成亿倍'],
  },
  {
    date: '2026-11-30',
    lunar: '十月廿二', tibetan: '十月廿二', tibetanMonth: '持众月',
  },

  // ── 2026 年 12 月 · 诸事圆满 · 持众月(12/1-8) / 庄严月(12/9+) ───────────
  {
    date: '2026-12-01',
    lunar: '十月廿三', tibetan: '十月廿三', tibetanMonth: '持众月',
    tags: ['九凶同聚', '十斋日'], auspicious: true,
    events: ['禅宗五祖弘忍大师圆寂日(汉)', '理发吉日：增上财富'],
  },
  {
    date: '2026-12-02',
    lunar: '十月廿四', tibetan: '十月廿四', tibetanMonth: '持众月',
    tags: ['十斋日'],
  },
  {
    date: '2026-12-03',
    lunar: '十月廿五', tibetan: '十月廿五', tibetanMonth: '持众月',
    auspicious: true,
    events: ['宗喀巴大师圆寂纪念日', '空行母荟供日,作何善恶成十万倍'],
    publicHoliday: '燃灯节',
  },
  {
    date: '2026-12-04',
    lunar: '十月廿六', tibetan: '十月廿六', tibetanMonth: '持众月',
    events: ['理发吉日：增上安乐'],
  },
  {
    date: '2026-12-05',
    lunar: '十月廿七', tibetan: '十月廿七', tibetanMonth: '持众月',
    events: ['理发吉日：诸事吉祥'],
  },
  {
    date: '2026-12-06',
    lunar: '十月廿八', tibetan: '十月廿八', tibetanMonth: '持众月',
    tags: ['十斋日'],
  },
  {
    date: '2026-12-07',
    lunar: '十月廿九', tibetan: '十月廿九', tibetanMonth: '持众月',
    tags: ['十斋日'],
    publicHoliday: '大雪',
  },
  {
    date: '2026-12-08',
    lunar: '十月三十', tibetan: '十月三十', tibetanMonth: '持众月',
    tags: ['八吉同聚', '十斋日'], auspicious: true,
    events: ['释迦牟尼佛加持日,作何善恶成九亿倍'],
  },
  {
    date: '2026-12-09',
    lunar: '十一月初一', tibetan: '十一月初一', tibetanMonth: '庄严月',
    tags: ['八吉同聚', '十斋日'], auspicious: true,
    events: ['禅定胜王佛加持日,作何善恶成百倍'],
  },
  {
    date: '2026-12-10',
    lunar: '十一月初二', tibetan: '十一月初二', tibetanMonth: '庄严月',
  },
  {
    date: '2026-12-11',
    lunar: '十一月初三', tibetan: '十一月初三', tibetanMonth: '庄严月',
    events: ['理发吉日：家族增长财富'],
  },
  {
    date: '2026-12-12',
    lunar: '十一月初四', tibetan: '十一月闰初三', tibetanMonth: '庄严月',
    isIntercalary: true,
    auspicious: true,
    events: ['净宗十三祖印光大师圆寂日(汉)'],
  },
  {
    date: '2026-12-13',
    lunar: '十一月初五', tibetan: '十一月初四', tibetanMonth: '庄严月',
    tags: ['飞幡日'],
    events: ['理发吉日：怀业增上，容光焕发'],
  },
  {
    date: '2026-12-14',
    lunar: '十一月初六', tibetan: '十一月初五', tibetanMonth: '庄严月',
    events: ['理发吉日：聚集广大财富'],
  },
  {
    date: '2026-12-15',
    lunar: '十一月初七', tibetan: '十一月初六', tibetanMonth: '庄严月',
  },
  {
    date: '2026-12-16',
    lunar: '十一月初八', tibetan: '十一月初七', tibetanMonth: '庄严月',
    tags: ['十斋日'],
  },
  {
    date: '2026-12-17',
    lunar: '十一月初九', tibetan: '十一月初八', tibetanMonth: '庄严月',
    auspicious: true,
    events: ['药师佛加持日,作何善恶成千倍', '理发吉日：长寿'],
  },
  {
    date: '2026-12-18',
    lunar: '十一月初十', tibetan: '十一月初九', tibetanMonth: '庄严月',
    events: ['理发吉日：易遇佳人'],
  },
  {
    date: '2026-12-19',
    lunar: '十一月十一', tibetan: '十一月初十', tibetanMonth: '庄严月',
    auspicious: true,
    events: ['莲师荟供日,作何善恶成十万倍', '理发吉日：增上欢喜'],
  },
  {
    date: '2026-12-20',
    lunar: '十一月十二', tibetan: '十一月十一', tibetanMonth: '庄严月',
    events: ['理发吉日：增上智慧和世聪'],
  },
  {
    date: '2026-12-21',
    lunar: '十一月十三', tibetan: '十一月十二', tibetanMonth: '庄严月',
    auspicious: true,
    events: ['唐代高僧慈恩大师(窥基法师)圆寂纪念日(汉)'],
  },
  {
    date: '2026-12-22',
    lunar: '十一月十四', tibetan: '十一月十三', tibetanMonth: '庄严月',
    tags: ['八吉同聚', '十斋日'],
    events: ['法王如意宝涅槃法会开始', '理发吉日：精进于佛法修持，最上'],
    publicHoliday: '冬至',
  },
  {
    date: '2026-12-23',
    lunar: '十一月十五', tibetan: '十一月十四', tibetanMonth: '庄严月',
    tags: ['十斋日'], auspicious: true,
    events: ['法王如意宝涅槃法会', '阿弥陀佛加持日,作何善恶成百万倍', '法王如意宝圆寂纪念日', '萨迦班智达圆寂纪念日', '理发吉日：财物增多'],
  },
  {
    date: '2026-12-24',
    lunar: '十一月十六', tibetan: '十一月十六', tibetanMonth: '庄严月',
  ...
  },
  {
    ...
    lunar: '十一月十八', tibetan: '十一月十八', tibetanMonth: '庄严月',
    tags: ['十斋日'],
    events: ['法王如意宝涅槃法会', '净宗二祖善导法师圆寂日(汉)'],
  },
  {
    date: '2026-12-27',
    lunar: '十一月十九', tibetan: '十一月十九', tibetanMonth: '庄严月',
    auspicious: true,
    events: ['法王如意宝涅槃法会', '日光菩萨圣诞日(汉)', '理发吉日：增胜善法'],
  },
  {
    date: '2026-12-28',
    lunar: '十一月二十', tibetan: '十一月二十', tibetanMonth: '庄严月',
