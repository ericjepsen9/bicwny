...
import { adminMeditationsRoutes } from './modules/meditations/admin.routes.js';
import { meditationRankingRoutes } from './modules/meditations/ranking.routes.js';
import { practiceStudentRoutes } from './modules/practice/student.routes.js';
...
import { classSessionsRoutes } from './modules/classes/sessions/routes.js';
import { postersRoutes } from './modules/posters/routes.js';
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  await app.register(adminMeditationsRoutes);
  await app.register(studentMeditationRoutes);
  await app.register(meditationRankingRoutes);
  await app.register(practiceStudentRoutes);
  ...
  await app.register(classSessionsRoutes);
  await app.register(postersRoutes);
