...
| TODO-C4 | ⚠️ **辅助员「发起班级法会」端点未明确**（DR-202）：09 能力13 委托边界列「发起班级法会」为 active 辅助员四项权之一，但未指向具体端点；「班级法会」概念落点在能力 46（法会），辅助员发起班级法会的 API + 权限映射待能力 46 验证时一并厘清 | 能力13 委托权 / 能力46 法会 | 能力 46 验证时 | DR-202 / 能力13 |
